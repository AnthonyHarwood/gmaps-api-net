...
namespace Google.Maps.Test
{
	...
	public class LocationTests
	{
		...
		[Test]
		public void GetAsUrlEncoded_via_interface()
		{
			var obj = new Location("City Hall, New York, NY") as Google.Maps.Internal.IUrlParameterProvider;

			string expected = "City%20Hall%2C%20New%20York%2C%20NY";
			string actual = obj.GetAsUrlParameter();
